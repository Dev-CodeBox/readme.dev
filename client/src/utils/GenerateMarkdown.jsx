...
const generateMarkdown = (data) => {
    ...
    if (author) {
        const username = author.split('/').filter(Boolean).pop();
        rendered.push(`## Author\n[${username}](${author})`);
    }
